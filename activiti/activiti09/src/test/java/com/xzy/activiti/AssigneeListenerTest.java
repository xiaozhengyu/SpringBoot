...
class AssigneeListenerTest {
    ...
    void testProcessDeployment() {
        ...
        Deployment deployment = repositoryService.createDeployment()
                .name("出差申请流程_listener")
                .addClasspathResource("bpmn/evection_listener.bpmn")
                .deploy();
    ...
    void testProcessInstanceStart() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("myEvection2");
